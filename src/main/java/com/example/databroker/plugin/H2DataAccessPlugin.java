...
@Component
public class H2DataAccessPlugin implements MessageProcessor {
    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public H2DataAccessPlugin(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    @Override
    public boolean canHandle(Message message) {
        return "h2_access".equals(message.getType());
    }
    ...
    public Object process(Message message) {
        ...
        if (operation == null) {
            return "Operation is required for h2_access";
        }
        ...
        try {
            ...
            return "Failed to execute h2_access operation: " + e.getMessage();
        }
    }
